      ...
      <div class="container-fluid">
        <div class="row">
          <v-container class="mt-3">
            <v-card color="white">
              <div class="row">
                <div class="col-12">
                  <v-card-title class="text-h5"> <v-icon>mdi-google-controller</v-icon> {{ category.name }} </v-card-title>
        ...
        <div class="row">
          <div class="col-sm-7 col-xs-12">
            <h2 class="text-2xl text-right rtl font-bold p-2 text-blue-400"> <v-icon>mdi-google-controller</v-icon> تصفح احدث وافضل الالعاب </h2>
            <Applist :data="all"></Applist>
          </div>
          <div class="col-sm-5 col-xs-12">
            ...
            <h2 class="text-2xl text-right rtl font-bold p-2 text-blue-400"> <v-icon>mdi-update</v-icon> العاب محدثة</h2>
...
export default {
  ...
  asyncData({$axios}) {
    return $axios.$get(process.env.apiUrl+'/games')
      .then(response => {
        return{
